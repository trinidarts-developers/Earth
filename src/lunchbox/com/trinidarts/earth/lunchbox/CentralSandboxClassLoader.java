...
import com.trinidarts.earth.lunchbox.pub.Util;
...
//			System.out.println("Public class load request: "+name);
	...
	private static final WhiteListItem[] whiteListClass = new WhiteListItem[] {
			...
			new WhiteListItem("com.trinidarts.earth.lunchbox.pub.ISandboxConnector", false),
			new WhiteListItem("com.trinidarts.earth.lunchbox.pub.IApplet", false),
			// these classes are available to the sandbox, but are limited to safe classes
			new WhiteListItem("com.trinidarts.earth.lunchbox.pub.", true),
	};
