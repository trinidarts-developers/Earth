 ...
 * 
 * It must have a com.trinidarts.earth.lunchbox.CentralSandboxClassLoader as its parent.
 * 
...
public class SandboxClassLoader extends ClassLoader {
	...
	public SandboxClassLoader(ClassLoader parent, ISandboxBytecodeSource connector) {
		super(parent);
		if (!parent.getClass().getName().equals("com.trinidarts.earth.lunchbox.CentralSandboxClassLoader")) {
